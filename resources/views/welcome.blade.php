<x-guest-layout>
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center py-4 sm:pt-0">
        ...
        <div class="w-full mx-auto">
            <div class="p-16 m-2 bg-gray-800 text-gray-200 w-full">
{{--                <div class="flex items-center">--}}

                    <span class="w-full mb-4 text-2xl font-extrabold text-gray-900 md:text-4xl lg:text-5xl whitespace-nowrap">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Tündérmosoly</span>
                        <img src="{{ asset('img/logo1.png') }}" alt="Tündérmosoly" class="w-28 inline">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r to-pink-600 from-purple-400">Alapítvány</span>
                    </span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 sm:gap-2 p-16 m-2 bg-gray-800 text-gray-200">
                <div class="justify-center items-center">
                    ...
                    <h1 class="mb-4 text-2xl font-extrabold text-gray-900 md:text-4xl lg:text-5xl">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r to-pink-600 from-purple-400">Tündérmosoly Alapítvány</span>
                    </h1>
                    {{--                    <span class="px-4 text-gray-200 text-2xl">Tündérmosoly Alapítvány</span>--}}
                </div>
